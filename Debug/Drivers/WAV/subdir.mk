...
Drivers/WAV/%.o Drivers/WAV/%.su: ../Drivers/WAV/%.c Drivers/WAV/subdir.mk
...
clean: clean-Drivers-2f-WAV

clean-Drivers-2f-WAV:
	-$(RM) ./Drivers/WAV/wav.d ./Drivers/WAV/wav.o ./Drivers/WAV/wav.su

.PHONY: clean-Drivers-2f-WAV
