...
OBJS += \
./Modules/mixer/Mixer.o 

CPP_DEPS += \
./Modules/mixer/Mixer.d 


# Each subdirectory must supply rules for building sources it contributes
Modules/mixer/%.o Modules/mixer/%.su: ../Modules/mixer/%.cpp Modules/mixer/subdir.mk
...
clean: clean-Modules-2f-mixer

clean-Modules-2f-mixer:
	-$(RM) ./Modules/mixer/Mixer.d ./Modules/mixer/Mixer.o ./Modules/mixer/Mixer.su

.PHONY: clean-Modules-2f-mixer
