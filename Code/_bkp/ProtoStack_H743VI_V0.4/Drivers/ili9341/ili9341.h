...
#define ADDR_DATA       *(uint8_t*)0x60100000

#define swap(a,b)    {int16_t t=a;a=b;b=t;}
#define RESET_ACTIVE HAL_GPIO_WritePin(FREE_LCD_RESET_GPIO_Port, FREE_LCD_RESET_Pin,   GPIO_PIN_RESET);
#define RESET_IDLE   HAL_GPIO_WritePin(FREE_LCD_RESET_GPIO_Port, FREE_LCD_RESET_Pin,   GPIO_PIN_SET);
#define BLACK        0x0000
#define BLUE         0x001F
#define RED          0x0F800
#define GREEN        0x07E0
