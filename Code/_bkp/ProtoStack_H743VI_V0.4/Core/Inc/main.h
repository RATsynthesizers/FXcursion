...
struct UPDATEGUIQUEUE_OBJ_t{                                // object data type
...
struct READWRITEUIQUEUE_OBJ_t{                                // object data type
	uint8_t reg;
	uint8_t bit;
};
...
#define FREE_SPI6_SW_CS_Pin GPIO_PIN_5
#define FREE_SPI6_SW_CS_GPIO_Port GPIOC
#define FREE_LCD_RESET_Pin GPIO_PIN_10
#define FREE_LCD_RESET_GPIO_Port GPIOD
