...
typedef struct {
	...
	uint8_t BufOffset;		// offset for double-buffer
	uint8_t rxBufPosition;	// current sample to process, 0..SAI_HALF_BUF
	uint8_t txBufPosition;	// current sample to output,  0..SAI_HALF_BUF
