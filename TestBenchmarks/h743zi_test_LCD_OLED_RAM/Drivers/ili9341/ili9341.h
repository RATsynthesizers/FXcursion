...
#define LCD_RST_ACTIVE HAL_GPIO_WritePin(USER_LCD_RESET_GPIO_Port, USER_LCD_RESET_Pin,   GPIO_PIN_RESET);
#define LCD_RST_IDLE   HAL_GPIO_WritePin(USER_LCD_RESET_GPIO_Port, USER_LCD_RESET_Pin,   GPIO_PIN_SET);
