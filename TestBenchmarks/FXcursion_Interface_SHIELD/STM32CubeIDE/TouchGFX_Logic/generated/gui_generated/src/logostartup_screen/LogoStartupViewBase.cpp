...
void LogoStartupViewBase::afterTransition()
{
    ...
    //Fade logoImage to alpha:0 with LinearIn easing in 7000 ms (420 Ticks)
    logoImage.clearFadeAnimationEndedAction();
    logoImage.setFadeAnimationDelay(120);
    logoImage.startFadeAnimation(0, 420, touchgfx::EasingEquations::linearEaseIn);
...
void LogoStartupViewBase::logoFadeEndedCallbackHandler(const touchgfx::FadeAnimator<touchgfx::Image>& comp)
{
    ...
    //Go to System with block transition
    application().gotoSystemScreenBlockTransition();
