...
extern touchgfx::GeneratedFont& getFont_PixelizerBold_22_4bpp();
extern touchgfx::GeneratedFont& getFont_verdana_40_4bpp();
extern touchgfx::GeneratedFont& getFont_PixelizerBold_16_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_PixelizerBold_22_4bpp()),
    &(getFont_verdana_40_4bpp()),
    &(getFont_PixelizerBold_16_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_PixelizerBold_22_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_verdana_40_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_PixelizerBold_16_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
