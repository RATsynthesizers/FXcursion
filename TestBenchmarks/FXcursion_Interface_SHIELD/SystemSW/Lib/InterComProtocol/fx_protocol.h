 ...
 *
 *            ############################################################
 *            #  ONE COPY, SHARED. This lives in SystemSW/Lib/           #
 *            #  InterComProtocol, which both firmwares pull in as the    #
 *            #  same git submodule - so there is no "keep in sync" any   #
 *            #  more, and no sync script. Editing it changes BOTH ends   #
 *            #  at once, which is the point: the two controllers cannot  #
 *            #  disagree about what a byte means.                        #
 *            #                                                           #
 *            #  It also means a change here is a change to a shared      #
 *            #  library. Bump PROTO_VERSION when a struct changes shape, #
 *            #  and remember that both boards must be flashed together   #
 *            #  when it does.                                            #
 *            ############################################################
 *
