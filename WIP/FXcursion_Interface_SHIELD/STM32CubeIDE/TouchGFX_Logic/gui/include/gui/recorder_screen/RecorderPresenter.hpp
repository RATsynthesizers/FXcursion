#ifndef RECORDERPRESENTER_HPP
#define RECORDERPRESENTER_HPP
...
class RecorderPresenter : public touchgfx::Presenter, public ModelListener
{
public:
    RecorderPresenter(RecorderView& v);
