#ifndef OUTPUTPRESENTER_HPP
#define OUTPUTPRESENTER_HPP
...
class OutputPresenter : public touchgfx::Presenter, public ModelListener
{
public:
    OutputPresenter(OutputView& v);
