 ...
 * @file      fx_amp.h
 *
 * @details   Amp, in two distinct types: mono-only and stereo-only.
 *
 *            They are separate effects, not one effect with a width flag - see
 *            the note at the top of fx_defs.h. Both variants live in fx_amp.c
 ...
 * bench read it.
 */
#define AMP_GAIN_MAX                (2.0f)
#define AMP_WIDTH_MAX               (2.0f)

/***************************************************************************************************
* Declarations of global (public) functions
***************************************************************************************************/

extern void FxAmpM_Process(const FX_CTX* pCtx, FLOAT32* const apPlane[], const U16 nFrames);
extern void FxAmpM_Reset(const U8 nPlaneBase, const U8 nWidth);

extern void FxAmpS_Process(const FX_CTX* pCtx, FLOAT32* const apPlane[], const U16 nFrames);
extern void FxAmpS_Reset(const U8 nPlaneBase, const U8 nWidth);



#endif // #ifndef FX_AMP_H
